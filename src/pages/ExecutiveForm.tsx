 ...
 // const [tags, setTags] = useState("");
  ...
  return (
    <Box sx={{ background: "#f5f5f5", minHeight: "100vh" }}>
      ...
      >
        <Typography mb={1} mt={1}>Title</Typography>
        {/* Title */}
        <TextField
          fullWidth
          label="Title"
        ...
        //margin="normal"
        />
        <Typography mb={1} mt={2}>Brief</Typography>
        {/* Brief */}
        <TextField
          fullWidth
          label="Brief"
        ...
        <Typography mb={1} mt={2}>Content Type</Typography>
        {/* Content Type */}
        ...
        <Typography mb={1} mt={2}>Campaign</Typography>
        {/* Campaign */}
        <FormControl fullWidth>
        ...
        <Typography mb={1} mt={2}>Event</Typography>
        <FormControl fullWidth>
        ...
        <Typography mb={1} mt={2}>Select SME</Typography>
        <FormControl fullWidth>
        ...
        {/* <Typography mb={1} mt={2}>Tags</Typography>
        <TextField
          fullWidth
          label="Tags"
          value={tags}
